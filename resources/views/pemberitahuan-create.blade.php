<x-admin-layout active="pemberitahuan" title="Cipta Pemberitahuan" subtitle="Buat pemberitahuan baharu untuk pengguna aplikasi.">
    ...
    <main class="content">
        ...
        <div class="form-container">
            <form class="form-card" method="POST" action="{{ route('pemberitahuan.store') }}">
                @csrf

                <div class="form-card-title">Cipta Pemberitahuan Baharu</div>

                <div class="form-group">
                    <label class="form-label">Tajuk <span class="required">*</span></label>
                    <input type="text" class="form-input @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Cth: Peraturan Dapur Baharu" required>
                    @error('title') <span class="form-error">{{ $message }}</span> @enderror
                </div>

                <div class="form-group">
                    <label class="form-label">Kandungan <span class="required">*</span></label>
                    <textarea class="form-textarea @error('content') is-invalid @enderror" name="content" placeholder="Taip kandungan pemberitahuan di sini..." required>{{ old('content') }}</textarea>
                    <div class="form-hint">
